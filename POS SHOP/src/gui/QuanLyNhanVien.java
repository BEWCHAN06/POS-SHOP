...
public class QuanLyNhanVien extends JPanel {
	...
	private JTextField txtTimnv;
	private JTable tableNgungLV;
	private JTextField txtTimmNV;
	private JTable tableDangLV;
	...
	public QuanLyNhanVien() {
		...
		pnThietlapTT.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2), "Thi\u1EBFt L\u1EADp Th\u00F4ng Tin Nh\u00E2n Vi\u00EAn", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		
		JTabbedPane tabbedLamviec = new JTabbedPane(JTabbedPane.TOP);
		GroupLayout gl_pnNhanvien = new GroupLayout(pnNhanvien);
		gl_pnNhanvien.setHorizontalGroup(
			gl_pnNhanvien.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_pnNhanvien.createSequentialGroup()
		...
		gl_pnNhanvien.setVerticalGroup(
			gl_pnNhanvien.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnNhanvien.createSequentialGroup()
		...
		gl_pnLamviec.setHorizontalGroup(
			gl_pnLamviec.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnLamviec.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_pnLamviec.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pnLamviec.createSequentialGroup()
							.addComponent(lbTimNV, GroupLayout.PREFERRED_SIZE, 124, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(txtTimmNV, GroupLayout.PREFERRED_SIZE, 295, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
							.addComponent(lbLocgt, GroupLayout.PREFERRED_SIZE, 119, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
							...
							.addComponent(cbxcv, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addComponent(scrollPaneDangLV, GroupLayout.PREFERRED_SIZE, 880, GroupLayout.PREFERRED_SIZE))
					.addContainerGap(12, Short.MAX_VALUE))
		);
		gl_pnLamviec.setVerticalGroup(
			gl_pnLamviec.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnLamviec.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_pnLamviec.createParallelGroup(Alignment.BASELINE)
						.addComponent(lbTimNV)
						.addComponent(txtTimmNV, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
		...
		tableDangLV.setModel(new DefaultTableModel(
			new Object[][] {
			...
			new String[] {
				"M\u00E3 Nh\u00E2n Vi\u00EAn", "H\u1ECD v\u00E0 T\u00EAn", "Ng\u00E0y Sinh", "\u0110\u1ECBa Ch\u1EC9", "S\u0110T", "Gi\u1EDBi T\u00EDnh", "L\u01B0\u01A1ng", "Email", "Ch\u1EE9c V\u1EE5"
			}
		));
		...
		gl_pnNgunglamviec.setHorizontalGroup(
			gl_pnNgunglamviec.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnNgunglamviec.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_pnNgunglamviec.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pnNgunglamviec.createSequentialGroup()
							.addComponent(lbTimkiem)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(txtTimnv, GroupLayout.DEFAULT_SIZE, 295, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(lbLocGT)
							.addGap(18)
							.addComponent(cbxGT, GroupLayout.PREFERRED_SIZE, 68, GroupLayout.PREFERRED_SIZE)
							...
							.addComponent(lbLocCV, GroupLayout.PREFERRED_SIZE, 119, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
							.addComponent(cbxGT_1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addComponent(scrollPaneDanglm, GroupLayout.PREFERRED_SIZE, 879, GroupLayout.PREFERRED_SIZE))
					.addContainerGap())
		);
		gl_pnNgunglamviec.setVerticalGroup(
			gl_pnNgunglamviec.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnNgunglamviec.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_pnNgunglamviec.createParallelGroup(Alignment.BASELINE)
						.addComponent(lbTimkiem)
		...
		gl_pnThietlapTT.setHorizontalGroup(
			gl_pnThietlapTT.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_pnThietlapTT.createSequentialGroup()
							...
							.addGroup(gl_pnThietlapTT.createParallelGroup(Alignment.LEADING, false)
								.addGroup(gl_pnThietlapTT.createSequentialGroup()
									...
									.addComponent(txtManhanvien, GroupLayout.PREFERRED_SIZE, 299, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_pnThietlapTT.createSequentialGroup()
									.addComponent(lbTenNV, GroupLayout.PREFERRED_SIZE, 97, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(txtTen, GroupLayout.PREFERRED_SIZE, 299, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_pnThietlapTT.createSequentialGroup()
									.addComponent(lbMK, GroupLayout.PREFERRED_SIZE, 89, GroupLayout.PREFERRED_SIZE)
									.addGap(18)
									.addComponent(txtMatkhau, GroupLayout.PREFERRED_SIZE, 299, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_pnThietlapTT.createSequentialGroup()
									.addComponent(lbVaitro, GroupLayout.PREFERRED_SIZE, 89, GroupLayout.PREFERRED_SIZE)
									.addGap(18)
									.addComponent(cbxVaitro, GroupLayout.PREFERRED_SIZE, 89, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_pnThietlapTT.createSequentialGroup()
									.addComponent(lbDiachi, GroupLayout.PREFERRED_SIZE, 89, GroupLayout.PREFERRED_SIZE)
									.addGap(18)
									.addComponent(txtDiachi, GroupLayout.PREFERRED_SIZE, 299, GroupLayout.PREFERRED_SIZE)))
							.addGap(63)
							.addGroup(gl_pnThietlapTT.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_pnThietlapTT.createSequentialGroup()
									.addComponent(lbNS, GroupLayout.PREFERRED_SIZE, 89, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(txtNgaysinh, GroupLayout.PREFERRED_SIZE, 299, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_pnThietlapTT.createSequentialGroup()
									.addComponent(lbSĐT, GroupLayout.PREFERRED_SIZE, 89, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(txtSĐT, GroupLayout.PREFERRED_SIZE, 299, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_pnThietlapTT.createSequentialGroup()
									.addGroup(gl_pnThietlapTT.createParallelGroup(Alignment.LEADING)
										.addComponent(lbEmail, GroupLayout.PREFERRED_SIZE, 89, GroupLayout.PREFERRED_SIZE)
										.addComponent(lbGT, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE)
										.addComponent(lbTrangthai, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE))
									.addPreferredGap(ComponentPlacement.RELATED)
									.addGroup(gl_pnThietlapTT.createParallelGroup(Alignment.LEADING)
										.addComponent(rdbtnTrangthai, GroupLayout.PREFERRED_SIZE, 111, GroupLayout.PREFERRED_SIZE)
										.addComponent(rdbtnGioitinh, GroupLayout.PREFERRED_SIZE, 111, GroupLayout.PREFERRED_SIZE)
		...
		gl_pnThietlapTT.setVerticalGroup(
			gl_pnThietlapTT.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnThietlapTT.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_pnThietlapTT.createParallelGroup(Alignment.BASELINE)
						.addComponent(lbMaNV)
						.addComponent(lbSĐT)
						.addComponent(txtSĐT, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
					...
					.addGroup(gl_pnThietlapTT.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(cbxVaitro, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_pnThietlapTT.createParallelGroup(Alignment.BASELINE)
						.addComponent(lbDiachi)
						.addComponent(lbTrangthai)
						.addComponent(rdbtnTrangthai)
		...
		pnTk.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2), "T\u00E0i Kho\u1EA3n", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		
		JPanel pnDanhsachTK = new JPanel();
		pnDanhsachTK.setBackground(new Color(255, 255, 255));
		pnDanhsachTK.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2), "Danh S\u00E1ch T\u00E0i Kho\u1EA3n", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		gl_pnTaikhoan.setHorizontalGroup(
			gl_pnTaikhoan.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnTaikhoan.createSequentialGroup()
					.addContainerGap()
		...
		gl_pnTaikhoan.setVerticalGroup(
			gl_pnTaikhoan.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnTaikhoan.createSequentialGroup()
					.addComponent(pnTk, GroupLayout.PREFERRED_SIZE, 215, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(pnDanhsachTK, GroupLayout.PREFERRED_SIZE, 435, Short.MAX_VALUE)
					.addContainerGap())
		);
		
		JScrollPane scrollPaneDS = new JScrollPane();
		GroupLayout gl_pnDanhsachTK = new GroupLayout(pnDanhsachTK);
		gl_pnDanhsachTK.setHorizontalGroup(
			gl_pnDanhsachTK.createParallelGroup(Alignment.LEADING)
		...
		gl_pnDanhsachTK.setVerticalGroup(
			gl_pnDanhsachTK.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnDanhsachTK.createSequentialGroup()
		...
		tableDSTK.setModel(new DefaultTableModel(
			new Object[][] {
				{null, null, null, null},
				{null, null, null, null},
				{null, null, null, null},
			...
			new String[] {
				"T\u00EAn T\u00E0i Kho\u1EA3n", "M\u1EADt Kh\u1EA9u", "H\u1ECD v\u00E0 T\u00EAn", "Ch\u1EE9c V\u1EE5"
			}
		));
