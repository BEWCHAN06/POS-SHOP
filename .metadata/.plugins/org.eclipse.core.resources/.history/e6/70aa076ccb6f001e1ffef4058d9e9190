...
public class banhang {
	...
	private void initialize() {
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addComponent(pnlMenu, GroupLayout.PREFERRED_SIZE, 210, GroupLayout.PREFERRED_SIZE)
					.addContainerGap(934, Short.MAX_VALUE))
		);
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addComponent(pnlMenu, GroupLayout.DEFAULT_SIZE, 661, Short.MAX_VALUE)
		);
		...
		lblNewLabel.setIcon(new ImageIcon(banhang.class.getResource("/icon/information-employee.png")));
			...
			gl_pnlMenu.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlMenu.createSequentialGroup()
					...
					.addGroup(gl_pnlMenu.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(pnlListMenu, GroupLayout.PREFERRED_SIZE, 197, GroupLayout.PREFERRED_SIZE))
		...
		iconSanPham.setIcon(new ImageIcon(banhang.class.getResource("/icon/box.png")));
		...
		iconSanPham_1.setIcon(new ImageIcon(banhang.class.getResource("/icon/bill.png")));
		...
		iconSanPham_1_1.setIcon(new ImageIcon(banhang.class.getResource("/icon/sale2.png")));
		...
		iconNhanVien.setIcon(new ImageIcon(banhang.class.getResource("/icon/emlpyee.png")));
		...
		iconKhachHang.setIcon(new ImageIcon(banhang.class.getResource("/icon/customer.png")));
		...
		iconThongKe.setIcon(new ImageIcon(banhang.class.getResource("/icon/statistical.png")));
		...
		iconDangXuat.setIcon(new ImageIcon(banhang.class.getResource("/icon/logout3.png")));
			...
			gl_pnlListMenu.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlListMenu.createSequentialGroup()
					...
					.addGroup(gl_pnlListMenu.createParallelGroup(Alignment.LEADING)
						.addComponent(btnBanHang, GroupLayout.PREFERRED_SIZE, 181, Short.MAX_VALUE)
						.addComponent(btnSanPham, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnHoaDon, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnKhuyenMai, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnNhanVien, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnKhachHang, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnThongKe, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnDangXuat, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE))
					.addContainerGap())
		);
		...
		lblIconBanHang.setIcon(new ImageIcon(banhang.class.getResource("/icon/buy.png")));
